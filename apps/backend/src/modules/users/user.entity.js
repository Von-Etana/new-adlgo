...
var wallet_entity_1 = require("../wallet/wallet.entity");
var User = function () {
    ...
    var _vehicleDetails_decorators;
    var _vehicleDetails_initializers = [];
    var _vehicleDetails_extraInitializers = [];
    ...
    var User = _classThis = /** @class */ (function () {
        function User_1() {
            ...
            this.isOnline = (__runInitializers(this, _isVerified_extraInitializers), __runInitializers(this, _isOnline_initializers, void 0));
            this.vehicleDetails = (__runInitializers(this, _isOnline_extraInitializers), __runInitializers(this, _vehicleDetails_initializers, void 0));
            this.wallet = (__runInitializers(this, _vehicleDetails_extraInitializers), __runInitializers(this, _wallet_initializers, void 0));
    ...
    (function () {
        ...
        _phone_decorators = [(0, typeorm_1.Column)({ unique: true })];
        _fullName_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _email_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _password_decorators = [(0, typeorm_1.Column)({ select: false, nullable: true })];
        _role_decorators = [(0, typeorm_1.Column)({ type: 'enum', enum: ['customer', 'driver', 'admin'], default: 'customer' })];
        _isVerified_decorators = [(0, typeorm_1.Column)({ default: false })];
        _isOnline_decorators = [(0, typeorm_1.Column)({ default: false })];
        _vehicleDetails_decorators = [(0, typeorm_1.Column)({ type: 'jsonb', nullable: true })];
        _wallet_decorators = [(0, typeorm_1.OneToOne)(function () { return wallet_entity_1.Wallet; }, function (wallet) { return wallet.user; })];
        ...
        __esDecorate(null, null, _vehicleDetails_decorators, { kind: "field", name: "vehicleDetails", static: false, private: false, access: { has: function (obj) { return "vehicleDetails" in obj; }, get: function (obj) { return obj.vehicleDetails; }, set: function (obj, value) { obj.vehicleDetails = value; } }, metadata: _metadata }, _vehicleDetails_initializers, _vehicleDetails_extraInitializers);
