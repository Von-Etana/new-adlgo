...
var OrdersController = function () {
    ...
    var OrdersController = _classThis = /** @class */ (function () {
        function OrdersController_1(biddingService) {
            this.biddingService = (__runInitializers(this, _instanceExtraInitializers), biddingService);
        }
        OrdersController_1.prototype.createOrder = function (createOrderDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    // Reuse the bidding service logic to create an order
                    return [2 /*return*/, this.biddingService.createOrder(createOrderDto)];
                });
            });
        };
        OrdersController_1.prototype.getOrder = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    // Mock fetch
                    return [2 /*return*/, {
        ...
        OrdersController_1.prototype.getUserOrders = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, [
    ...
    (function () {
        ...
        _getUserOrders_decorators = [(0, common_1.Get)('user/:userId')];
