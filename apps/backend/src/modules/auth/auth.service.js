...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(userRepository, sessionRepository) {
            this.userRepository = userRepository;
            this.sessionRepository = sessionRepository;
        }
        AuthService_1.prototype.hashPassword = function (password) {
            // Simple hash for prototype (use bcrypt in production if available)
        ...
        AuthService_1.prototype.register = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userRepository.findOne({ where: { phone: data.phone } })];
                        case 1:
        ...
        AuthService_1.prototype.login = function (phone, password) {
            return __awaiter(this, void 0, void 0, function () {
                var user, hashedPassword, token, expiresAt, session;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (password && user.password) {
                                ...
                                // User has no password set (maybe created via other means), allow login if dev mode or handle logic
                                // For now, fail
                                throw new common_1.UnauthorizedException('Invalid credentials');
                            }
        ...
        AuthService_1.prototype.validateSession = function (token) {
            return __awaiter(this, void 0, void 0, function () {
                var session;
                return __generator(this, function (_a) {
                    switch (_a.label) {
